...
# Hi there, I'm kluhu541

### Backend Developer (Python) · Open to internships
...
- Backend developer, building server-side apps, bots and APIs with Python
- looking for a **junior backend position or internship**
- Learning: databases, clean architecture, Docker & deployment
- Also comfortable with a bit of Java
...
- Backend-разработчик, пишу серверные приложения, ботов и API на Python
- ищу **позицию junior backend-разработчика или стажировку**
- Изучаю: базы данных, чистую архитектуру, Docker и деплой
- Немного работаю с Java
